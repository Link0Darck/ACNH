...
namespace SysBot.ACNHOrders
{
    ...
    {
        private const string BanListUri = "https://raw.githubusercontent.com/Link0Darck/ACNH/main/Resources/AbuseList.txt";
        ...
        /// <summary>
        /// Test d'arrivée de l'utilisateur
        /// </summary>
        ...
        public bool LogUser(string user, string town, string id)
        {
            ...
            {
                LogUtil.LogInfo((Globals.Bot.Config.OrderConfig.PingOnAbuseDetection ? $"Pinging <@{Globals.Self.Owner}>: " : string.Empty) + $"{user} à partir de {town} ({id}) existe avec au moins une identité précédente: {exists.Identity}", Globals.Bot.Config.IP);
            }
